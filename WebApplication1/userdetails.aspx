<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="userdetails.aspx.cs" Inherits="WebApplication1.userdetails" %>
<%@ Register Src="~/capestartMT.ascx" TagPrefix="uc1" TagName="ContactUC" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">


     <div class="jumbotron">
            <uc1:contactuc runat="server" id="ContactUC" Header="User page loaded via User Control" />
    </div>
    <asp:Label ID="username" runat="server" Text="Name"></asp:Label> <br />
